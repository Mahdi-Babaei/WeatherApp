      ...
      <div className="bg-dark-secondary rounded-3xl flex flex-col gap-y-8 py-5 px-8 h-full text-xl font-NunitoLight">
          ...
          <div className="grid grid-cols-2 text-center gap-x-6">
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <div>
                <h6>Unhealthy</h6>
                <p className="text-base h-18">Limit strenuous outdoor activities, especially if you have a health condition.</p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <div>
                <h6>High</h6>
                <p className="text-base h-18">Reduce time in the sun, especially during midday. Take all precautions. </p>
              </div>
            </div>
          </div>
      </div>
