...
export default function AddCity() {
  return (
    <div className='flex items-center gap-x-5 border-2 border-dashed border-gray-400 dark:border-white/20 rounded-xl xl:rounded-3xl px-2 2xl:px-5 select-none md:h-24'>
