  ...
  return (
    <>
        {isLoading ? <p>Loading...</p> : !fetchData ? null : (
          <div className={`rounded-xl 2xl:rounded-3xl flex flex-col items-center justify-between gap-y-8 2xl:gap-y-0 bg-gradient-to-t ${fetchData.current.is_day ? 'from-blue-600 via-vlue-400 to-blue-300' : 'from-gray-950 via-blue-950 to-blue-800'}  p-5 text-zinc-100 overflow-hidden h-full`}>
