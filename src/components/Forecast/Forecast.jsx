  ...
  return (
    <>
        {isLoading ? <p>Loading ...</p> : !fetchData ? null : (
            <div className='bg-light-secondary dark:bg-dark-secondary rounded-3xl flex flex-col justify-between gap-y-5 py-5 px-8 h-full relative shadow-sm'>
                ...
                <div className='bg-gradient-to-t from-blue-500 via-blue-400  to-blue-300 -mx-5 px-5 py-5 rounded-3xl text-zinc-100'>
